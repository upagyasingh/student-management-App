...
//       c1.removeAllItems(); 
        try{
            Connection con = DBConnect.connect();
            PreparedStatement p1 = con.prepareStatement("select * from feestruct where" +
                    " course =? and branch = ?");
...
//                    System.out.println("hello");
            ...
            if(rs.next()){
              totalAmt  = rs.getString(t5.getSelectedItem().toString()); // 30,000
            }
            int subAmt = Integer.parseInt(t6.getText());//20,000
            int pend = Integer.parseInt(totalAmt)-subAmt;
//           if pend ==0    fully submitted   done
//              pend !=0     pending   pend
...
//            System.out.println(changePendFee);
            ...
            if(changePendFee ==0){
                ...
                PreparedStatement p2 = con.prepareStatement("update studfee " +
                        "set fee = ? , status = ? where rollno=? ");
